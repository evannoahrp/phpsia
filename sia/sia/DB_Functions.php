...
class DB_Functions {
	...
	public function updateBiodata($kode_pegawai, $glr_dpn, $glr_blk, $nik, $npwp, $alamat_skr, $telp_rumah, $no_hp1, $email1, $tempat_lahir, $tgl_lahir, $kode_status_keluar, $kode_status_pegawai, $nidn, $alamat_ktp, $email2, $no_hp2){
		
		if ($stmt = $this->conn->prepare("UPDATE pegawai SET glr_dpn = ?, glr_blk = ?, nik = ?, npwp = ?, alamat_skr = ?, telp_rumah = ?, no_hp1 = ?, email1 = ?, tempat_lahir = ?, tgl_lahir = ?, kode_status_keluar = ?, kode_status_pegawai = ?, nidn = ?, alamat_ktp = ?, email2 = ?, no_hp2 = ? WHERE kode_pegawai = ?")) {
			
			$stmt->bind_param("sssssssssssssssss", $glr_dpn, $glr_blk, $nik, $npwp, $alamat_skr, $telp_rumah, $no_hp1, $email1, $tempat_lahir, $tgl_lahir, $kode_status_keluar, $kode_status_pegawai, $nidn, $alamat_ktp, $email2, $no_hp2, $kode_pegawai);
